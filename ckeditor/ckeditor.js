...
For licensing, see LICENSE.md or http://ckeditor.com/license PROPRIO LUI SI E' LUI
*/
(function() {
                        ...
                        if (y.length)
                            for (var y = y.slice(0), z, o = 0; o < y.length; o++) {
                                if (n.errorProof) try {
                                    z = y[o].call(this,
                                        h, l, f, b)
                                } catch (r) {} else z = y[o].call(this, h, l, f, b);
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                var d = 0,
                    ...
                    c = this.getDocument(),
                    e = c.getBody(),
                    h = c.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var n =
                        this.$.getBoundingClientRect(),
                        t = c.$.documentElement,
                        y = t.clientTop || e.$.clientTop || 0,
                        z = t.clientLeft || e.$.clientLeft || 0,
                        o = true;
                    if (CKEDITOR.env.ie) {
            ...
            copyAttributes: function(a, b) {
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    var l = c[e],
                        ...
                        n;
                    if (!(h in b))
                        if (h == "checked" && (n = this.getAttribute(h))) a.setAttribute(h, n);
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                var u = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    p = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(n) : d.getNext();
                this._.guardLTR = function(a, b) {
                    return (!b || !u.equals(a)) && (!p ||
                        !a.equals(p)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var g = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    h = e.type == CKEDITOR.NODE_ELEMENT ? f ? e.getChild(f - 1) : null : e.getPrevious();
            ...
            if (this.current) d = this.current[s](false, k, i);
            else {
                if (a) d.type ==
    ...
    (function() {
        ...
        var c = function(a) {
            ...
            f = function(a, b, c, d) {
                ...
                if (e.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (q >= e.getChildCount()) {
                        ...
                        i = true
                    } else e = e.getChild(q).getPrevious();
                else {
                ...
                for (c = k; c < g.length; c++) {
                    ...
                    if (!q[c] || h.$.parentNode != q[c].$.parentNode)
                        for (h = h.getPrevious(); h;) {
                            ...
                            F = h.getPrevious();
                            if (b == 2) p.$.insertBefore(h.$.cloneNode(true), p.$.firstChild);
                            else {
                                h.remove();
            ...
            h = CKEDITOR.dom.walker.ignored(true);
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                                    ...
                                    if (k.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        if (u && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                                            ...
                                            if (d.test(h)) k = null;
                                                ...
                                                for (var l = k.$.getElementsByTagName("*"), F = 0, j; j = l[F++];)
                        ...
                        if (p.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(p.substring(l)).length) u = true;
                            else {
                                u = !p.getLength();
                                if (l == p.getLength()) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var I, w, B = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            v = null,
                            C = function(a) {
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (e && e.type == CKEDITOR.NODE_TEXT)
                        if (q)
                            if (q >= e.getLength()) d.setStartAfter(e);
                            else {
                                d.setStartBefore(e);
                                i = 0
                            } else d.setStartBefore(e); if (f && f.type == CKEDITOR.NODE_TEXT)
                        if (g)
                            if (g >= f.getLength()) d.setEndAfter(f);
                            else {
                                d.setEndAfter(f);
                                m = 0
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    j = q.startPath();
                    var x = q.endPath(),
                        i = !q.collapsed && f(q, j.block),
                        m = !q.collapsed && f(q, x.block, 1);
                ...
                for (this._.nextNode =
                    null; x;) {
                    var i = 0,
                        m = x.hasAscendant("pre"),
                        k = x.type != CKEDITOR.NODE_ELEMENT,
                        s = 0;
                    if (k) x.type == CKEDITOR.NODE_TEXT && d.test(x.getText()) && (k = 0);
                    else {
                        var u = x.getName();
                        if (CKEDITOR.dtd.$block[u] && x.getAttribute("contenteditable") == "false") {
                            ...
                            c(this, a, b);
                            break
                        } else if (x.isBlockBoundary(this.forceBrBreak && !m && {
                            br: 1
                        })) {
                            if (u == "br") k = 1;
                    ...
                    if (j && !i)
                        for (; !x.getNext(l) && !z;) {
                            u = x.getParent();
                            if (u.isBlockBoundary(this.forceBrBreak && !m && {
                                br: 1
                            })) {
                                i = 1;
                                k = 0;
                ...
                if (!b) {
                    ...
                    b = b.block;
                    if (!b && x && !this.enforceRealBlocks && i[x.getName()] && j.checkStartOfBlock() && j.checkEndOfBlock() && !x.equals(j.root)) b = x;
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                k = b[f];
                k = typeof k == "boolean" ? {} : typeof k == "function" ? {
                    match: k
                } : L(k);
            ...
            for (var b = e.elements, e = e.generic, h, c = 0, d = a.length; c < d; ++c) {
                ...
                if (f.elements === true || f.elements === null) e[k ? "unshift" : "push"](f);
                else {
                    i = f.elements;
                    delete f.elements;
                    for (h in i)
                        if (b[h]) b[h][k ? "unshift" : "push"](f);
                        else b[h] = [f]
                }
            }
        }
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = false, e = a === true, k = b.length; k--;)
                        if (e || a(b[k])) {
                            b.splice(k, 1);
                            d =
                                true
        ...
        function z(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a: for (var m = a.elementCallbacks, p = 0, A = m.length, o; p < A; ++p)
                    if (o = m[p](b)) {
                        i = o;
                        break a
                    }if (i) return i
        ...
        function u(a, b) {
            ...
            for (f in d)
                if (f == "class") {
                    c = d[f].split(/\s+/);
                    for (i = a.classes.join("|"); r = c.pop();)
                        if (i.indexOf(r) == -1) return false
                } else if (a.attributes[f] != d[f]) return false;
            for (k in e)
                if (a.styles[k] != e[k]) return false;
            return true
        }
                        ...
                        a: {
                            ...
                            if (i)
                                for (p = 0; p < i.length; ++p)
                                    if ((A = d.match(i[p])) && A[0].length == d.length) {
                                        c = true;
                                        break a
                                    }
        ...
        load: function(a, e, b) {
            ...
            CKEDITOR.scriptLoader.load(d, function(a, d) {
                ...
                for (var f = 0; f < a.length; f++)
                    for (var o = g[a[f]], r = 0; r < o.length; r++) {
                        var q = o[r];
                        j[q] = this.get(q);
                        c[q] = 1
                    }
                ...
                g = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (j in a) {
                            ...
                            if (!e[j]) {
                                if (t.icons)
                                    for (var z = t.icons.split(","), o = z.length; o--;) CKEDITOR.skin.addIcon(z[o], t.path + "icons/" + (CKEDITOR.env.hidpi && t.hidpi ? "hidpi/" : "") + z[o] + ".png");
                                e[j] = 1
                            }
                            if (y) {
                                y.split && (y = y.split(","));
    ...
    (function() {
        ...
        function n(a) {
            ...
            if (d) var f = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(f, ""),
                c = c + ("," + d);
            if (e) var k = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
                c = c.replace(k, "");
            CKEDITOR.env.air &&
                (c = c + ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var i in c) {
                    ...
                    if (h && (w = h.match(k)))
                        for (; h = w.pop();) CKEDITOR.tools.setTimeout(function(a, b) {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(d, g, j) {
                ...
                var o = new CKEDITOR.htmlParser,
                    r = g instanceof CKEDITOR.htmlParser.element ? g : typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment,
                    q = [],
                    x = [],
                    i = r,
                    m = r.name == "textarea",
                    ...
                    if (a(f)) q.push(f);
                        ...
                        if (d == "pre") k = true;
                            ...
                            for (;;) {
                                ...
                                if (!f.isUnknown && !i.isUnknown && !r[d])
                                    if (i.isOptionalClose) o.onTagClose(p);
    ...
    (function() {
                ...
                return function(f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [],
                            ...
                            p, A;
                        if (i)
                            for (r(i, 1) && k.push(i); i;) {
                                if (d(i) && (p = c(i)) && r(p))
                                    if ((A = c(p)) && !d(A)) k.push(p);
                                    else {
                                        m(s).insertAfter(p);
                                        p.remove()
                                    }
                        ...
                        if (k = (typeof e == "function" ? e(f) : e) !== false)
                            if (!s && !CKEDITOR.env.needsBrFiller &&
        ...
        var q = /(?:&nbsp;|\xa0)$/,
            x = "{cke_protected}",
            i = CKEDITOR.dtd,
            m = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
            k = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block),
            s = {
                elements: {
                    input: j,
                    textarea: j
        ...
        var S = /<(a|area|img|input|source)\b([^>]*)>/gi,
            ...
            B = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
    ...
    (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (f)
                        for (;
                            (s = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[s.getName()]) && (!h || !h[e]);)
                            if (s.getName() in CKEDITOR.dtd.span) b.splitElement(s);
        ...
        var h = CKEDITOR.dom.walker.bogus(),
            n = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
        ...
        var z = function() {
                ...
                function d(b, c) {
                    var e = [],
                        ...
                        k, m = 0,
                        p = h[c],
                        C = !b.is(h.$inline) || b.is("br");
                    for (C && e.push(" "); m < i; m++) {
                        k = f.getItem(m);
                        a(k) &&
                            !k.is(p) ? e = e.concat(d(k, c)) : e.push(k)
                    }
                    C && e.push(" ");
                    return e
                }
                ...
                var h = CKEDITOR.dtd,
                    ...
                    l = CKEDITOR.tools.extend({}, h.$inline);
                delete l.br;
                return function(g, n, u) {
                    ...
                    if (!t.checkReadOnly()) {
                        var B = (new CKEDITOR.dom.elementPath(t.startContainer, t.root)).blockLimit || t.root,
                            n = {
                                type: n,
                                dontFilter: w,
                                editable: g,
                        ...
                        if (!o.collapsed) {
                            var B = A.block || A.blockLimit,
                                y = o.getCommonAncestor();
                            B && (!B.equals(y) && !B.contains(y) && o.checkEndOfBlock()) && n.zombies.push(B);
                            o.deleteContents()
                        }
                        for (;
                            (E = a(o.startContainer) && o.startContainer.getChild(o.startOffset - 1)) && a(E) && E.isBlockBoundary() && C.contains(E);) o.moveToPosition(E, CKEDITOR.POSITION_BEFORE_END);
                        ...
                        if (v = u) {
                            ...
                            if (/^\s+|\s+$/.test(u) && "span" in CKEDITOR.dtd[E]) var z = '<span data-cke-marker="1">&nbsp;</span>',
                                u = z + u + z;
                            ...
                            for (k(C, G); v < C.length; v++) {
                                ...
                                if (D) w = v > 0;
                                    ...
                                    if (U) {
                                        ...
                                        U = 0
                                    } else G.insertNode(A.node); if (A.lastNotAllowed && v < C.length - 1) {
                        ...
                        for (U = K.createBookmark(); H = n.zombies.pop();)
                            if (H.getParent()) {
                                Q = K.clone();
    ...
    (function() {
        ...
        function c(a) {
            ...
            var c = a.startContainer,
                d = a.getPreviousNode(z, null, c),
                e = a.getNextNode(z, null, c);
        ...
        var t, y, z = CKEDITOR.dom.walker.invisible(1),
            o = function() {
                function a(b) {
                    return function(a) {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            f.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && i.attachListener(i, "focus", function(a) {
                        a.removeListener();
                        if (n !== 0)
                            if ((a = f.getSelection().getNative()) && a.isCollapsed && a.anchorNode == i.$) {
                                a = f.createRange();
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = r ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        return {
                            container: v,
                            offset: j > 0 ? -h : v.nodeValue.length + h
                        }
                    };
                    return function() {
                        var a = this.getNative(),
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() {
                        ...
                        for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && (!(c = a.getEnclosedNode()) ||
                            !(c.type == CKEDITOR.NODE_ELEMENT && x[c.getName()] && (d = c))); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d && d.$
                    });
            ...
            getSelectedText: function() {
                ...
                var b = this.getNative(),
                    b = r ? b.type == "Control" ? "" : b.createRange().text : b.toString();
    ...
    (function() {
        ...
        function e(b) {
            ...
            if (b.collapsed) {
                ...
                var f = this.element,
                    h = this._.definition,
                    i, g = h.ignoreReadonly,
                    j = g || h.includeReadonly;
                ...
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) {
                        ...
                        var t = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null,
                            r = t && o.getAttribute("contentEditable") == "false",
                            s = t && o.getAttribute("data-nostyle");
                        if (t && o.data("cke-bookmark")) {
                            o =
                                o.getNextSourceNode(true);
                            continue
                        }
                        if (r && j && CKEDITOR.dtd.$block[t])
                            for (var y = o, u = c(y), x = void 0, J = u.length, O = 0, y = J && new CKEDITOR.dom.range(y.getDocument()); O < J; ++O) {
                                var x = u[O],
                                    S = CKEDITOR.filter.instances[x.data("cke-filter")];
                                if (S ? S.check(this) : 1) {
                        ...
                        if (u)
                            if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || i) && (!h.parentRule || h.parentRule(u))) {
                                ...
                                if (t == CKEDITOR.NODE_TEXT || r || t == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                    for (var t = o, P;
                                        (g = !t.getNext(F)) && (P = t.getParent(), k[P.getName()]) && (P.getPosition(l) | I) == I && (!h.childRule || h.childRule(P));) t = P;
                                    p.setEndAfter(t)
                                }
                            } else g = true;
                        else g = true;
                        ...
                        for (var g = q(this, d), r = g.hasAttributes(), s = p.getCommonAncestor(), t = {}, u = {}, x = {}, J = {}, V, R, Y; g && s;) {
                            if (s.getName() == f) {
                                for (V in h.attributes)
                                    if (!J[V] &&
                                        (Y = s.getAttribute(R))) g.getAttribute(V) == Y ? u[V] = 1 : J[V] = 1;
                                for (R in h.styles)
                                    if (!x[R] && (Y = s.getStyle(R))) g.getStyle(R) == Y ? t[R] = 1 : x[R] = 1
                            }
                            s = s.getParent()
                        }
        ...
        function y(a, b) {
            var c = this._.definition,
                ...
                h;
            for (h in d)
                if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != k(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                    f = a.hasAttribute(h);
                    a.removeAttribute(h)
                }
            for (var g in c)
                if (!(this._.definition.fullMatch && a.getStyle(g) != k(g, c[g], true))) {
                    f = f || !!a.getStyle(g);
                    a.removeStyle(g)
                }
            o(a, e, u[a.getName()]);
        ...
        var u = {
            ...
            J = CKEDITOR.dom.walker.whitespaces(1);
                        ...
                        for (var g in c)
                            if (g != "_length") {
                                ...
                                if (g == "style") a: {
                                    ...
                                    h = void 0;
                                    for (h in d)
                                        if (!(h in e && (e[h] == d[h] || d[h] == "inherit" || e[h] == "inherit"))) {
                                            d = false;
                                            break a
                                        }
                                    d = true
    ...
    (function() {
        function a(a, c, e) {
            var d = a.serializable,
                ...
                j = e ? "endOffset" : "startOffset",
                l = d ? c.document.getById(a.startNode) : a.startNode,
            ...
            createIterator: function() {
                ...
                return {
                    getNextRange: function(g) {
                        ...
                        if (j && a.length > 1) {
                            if (!d)
                                for (var l = a.length - 1; l >= 0; l--) e.unshift(a[l].createBookmark(true));
                            if (g)
                                for (var h = 0; a[d + h + 1];) {
    ...
    */
    ...
    (function() {
        ...
        function ha(a) {
            var c = a.doc,
                ...
                b = this.path + "images/" + (n.hidpi ? "hidpi/" : "") + "icon" + (a.rtl ? "-rtl" : "") +
                ".png";
            q(d, {
                attach: function() {
    ...
    (function() {
        var h = [CKEDITOR.CTRL + 90, CKEDITOR.CTRL + 89, CKEDITOR.CTRL + CKEDITOR.SHIFT + 90],
            j = {
                8: 1,
                46: 1
            };
        CKEDITOR.plugins.add("undo", {
            init: function(a) {
                ...
                var c = a.undoManager = new k(a),
                    e = c.editingHandler = new l(c),
                    f = a.addCommand("undo", {
                        exec: function() {
        ...
        k.prototype = {
            ...
            previousKeyGroup: -1,
            type: function(a) {
                var b = this.keyGroupsEnum,
                    a = j[a] ? b.FUNCTIONAL : b.PRINTABLE,
                    d = this.strokesRecorded[a] + 1,
                    c = a !== this.previousKeyGroup,
                    e = 25 <= d,
                    b = a == b.FUNCTIONAL ? b.PRINTABLE : b.FUNCTIONAL;
            ...
            getNextImage: function(a) {
                ...
                if (d)
                    if (a)
                        for (c = this.index - 1; 0 <= c; c--) {
                            if (a = b[c], !d.equalsContent(a)) return a.index = c, a
                        } else
                            for (c = this.index + 1; c < b.length; c++)
                                if (a = b[c], !d.equalsContent(a)) return a.index = c, a;
                return null
            },
            redoable: function() {
        ...
        l.prototype = {
            ...
            onKeyup: function(a) {
                ...
                if (CKEDITOR.env.ie && a in j && this.lastKeydownImage) {
                    if (this.lastKeydownImage.equalsContent(new g(d, !0))) return;
                    f += 1
                }
                if (0 < f) f -= 1, b.type(a);
            ...
            attachListeners: function() {
                var a = this.undoManager.editor.editable(),
                    b = this;
